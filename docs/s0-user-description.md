...
![S0 LABELED](images/s0-labeled.png)
...
- **Power JST**: The board can be powered by a battery of maximum 7.4V connected via the battery JST as labelled on the board.
